#!/bin/bash
BUILD_JAR=$(ls /home/ec2-user/server/wiselife/build/libs/wiselife-0.0.1-SNAPSHOT.jar)
...
sudo nohup java -jar $DEPLOY_JAR --spring.profiles.active=prod >> /home/ec2-user/deploy.log 2>/home/ec2-user/deploy_err.log &
